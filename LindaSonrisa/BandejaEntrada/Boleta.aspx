<%@ Page Title="Boleta" Language="C#" MasterPageFile="~/BandejaEntrada/BandejaEntrada.Master" AutoEventWireup="true" CodeBehind="Boleta.aspx.cs" Inherits="LindaSonrisa.BandejaEntrada.Boleta" %>
              ...
              <div class="row invoice-info">
                <div class="col-sm-4 invoice-col">
                  ...
                  <address>
                    ...
                    Email: lindasonrisaduocportafolio@gmail.com
                  </address>
                </div>
                <!-- /.col -->
                <div class="col-sm-4 invoice-col">
                  ...
                  <address>
                    ...
                    Nombre de usuario: nachorro<br>
                    Email: i.sallorenzo@alumnos.duoc.cl
                  </address>
                </div>
                <!-- /.col -->
                <div class="col-sm-4 invoice-col">
                  <b>Boleta #9</b><br>
                  <br>
                  <b>Número de orden:</b> <asp:Label ID="lblNumOrden" runat="server" Text="9" ></asp:Label><br>
                </div>
                <!-- /.col -->
              </div>
              <!-- /.row -->
