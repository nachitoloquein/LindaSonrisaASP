<%@ Page Title="Registro " Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AgregarUsuario.aspx.cs" Inherits="LindaSonrisa.AgregarUsuario" %>
			...
			<div class="wrap-login100">
				...
				<section class="login100-form validate-form">
                    <div class="wrap-input100 validate-input m-b-26">
						...
						<input class="input100" type="text" name="username" id="TxtCorreo" runat="server" placeholder="Ingrese su correo electrónico">
					...
					<div class="container-login100-form-btn">
						<button class="login100-form-btn" id="btnEntrar" runat="server" onserverclick="BtnAceptar_Click">
							Aceptar
						</button>
					</div>
				</section>
