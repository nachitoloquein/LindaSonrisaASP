<%@ Page Title="Gestion Tipo Producto" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="GestionTipoProducto.aspx.cs" Inherits="LindaSonrisa.Admin.GestionTipoProducto" EnableEventValidation = "false" %>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Gestión de Tipos de producto</li>
                        </ol>
                    </div>
                </div>
            </div>
