    ...
    public partial class GestionTipoProducto : System.Web.UI.Page
    {
        ...
        protected void btnAgregar_click(object sender, EventArgs e)
        {
            if (sqlcon.State == ConnectionState.Closed)
                sqlcon.Open();
            SqlCommand sqlcmd = new SqlCommand("AgregarActualizarTipoProducto", sqlcon);
        ...
        void cargarDatos()
        {
            if (sqlcon.State == ConnectionState.Closed)
                sqlcon.Open();
            SqlDataAdapter sqlDa = new SqlDataAdapter("VerTipoProducto", sqlcon);
        ...
        protected void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            if (sqlcon.State == ConnectionState.Closed)
                sqlcon.Open();
            SqlDataAdapter sqlDa = new SqlDataAdapter("BuscarTipoProductoPorId", sqlcon);
            sqlDa.SelectCommand.CommandType = CommandType.StoredProcedure;
        ...
        protected void btnEliminar_click(object sender, EventArgs e)
        {
            if (sqlcon.State == ConnectionState.Closed)
                sqlcon.Open();
            SqlCommand sqlDa = new SqlCommand("EliminarTipoProductoPorId", sqlcon);
        ...
        protected void btnExportar_click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=InformeDatosTipoProducto.xls");
            Response.Charset = "";
