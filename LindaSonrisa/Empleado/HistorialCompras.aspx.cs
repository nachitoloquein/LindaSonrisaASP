...
namespace LindaSonrisa.Empleado
{
    public partial class HistorialCompras : System.Web.UI.Page
    {
        ...
        private void cargarDatos()
        {
            ...
            command.CommandText = "verProductoEmpleado";
        ...
        protected void PedidoRecibido_Click(object sender, EventArgs e)
        {
            ...
            if (sqlcon.State == ConnectionState.Closed)
                sqlcon.Open();
            SqlCommand sqlDa = new SqlCommand("pedidoRecibidoEmpleado", sqlcon);
        ...
        protected void PedidoCancelado_Click(object sender, EventArgs e)
        {
            ...
            if (sqlcon.State == ConnectionState.Closed)
                sqlcon.Open();
            SqlCommand sqlDa = new SqlCommand("CancelarPedido", sqlcon);
            sqlDa.CommandType = CommandType.StoredProcedure;
            sqlDa.Parameters.AddWithValue("@id", id);
            sqlDa.ExecuteNonQuery();
            sqlcon.Close();
