<%@ Page Title="Comprar" Language="C#" MasterPageFile="~/Empleado/EmpleadoMaster.Master" AutoEventWireup="true" CodeBehind="Compra.aspx.cs" Inherits="LindaSonrisa.Empleado.Compra" %>
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="comboProveedor" CssClass="form-control" runat="server" AutoPostBack="True" OnSelectedIndexChanged="comboProveedor_SelectedIndexChanged"></asp:DropDownList>
                            </div>
                             <div class="form-group">
